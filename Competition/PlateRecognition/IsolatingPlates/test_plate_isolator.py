...
import cv2
from plate_isolator_orb import PlateIsolatorOrb
...
def test_image(img_path, isolator, duration=10000):
    ...
    matches = isolator.detectFeature(detect_image, detect_image, duration=duration)
    print(matches)
    pass
...
def main():
    ...
    isolator = PlateIsolatorOrb(feature_img)
